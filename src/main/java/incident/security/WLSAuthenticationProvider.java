...
import incident.repos.UserPermissionRepo;
import incident.repos.UserRepo;
import incident.services.SysConfigService;
...
public class WLSAuthenticationProvider implements AuthenticationProvider{
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		if(name!= null) {
			...
			incident.models.User user = this.userRepository.findByUSERNAME(name);
			...
			incident.models.User user = this.userRepository.findByUSERNAME(userNAME);
